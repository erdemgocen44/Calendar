...
class MoiHeadMap extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return HeatMap(
      datasets: {
        DateTime(2022, 12, 23): 3,
        DateTime(2022, 12, 24): 7,
        DateTime(2022, 12, 25): 10,
        DateTime(2022, 12, 26): 13,
        DateTime(2022, 12, 27): 6,
      },
      ...
      colorsets: const {
        ...
        8: Color.fromARGB(250, 238, 216, 18),
        9: Color.fromARGB(260, 238, 216, 18),
        10: Color.fromARGB(270, 238, 216, 18),
      },
    );
  }
}
